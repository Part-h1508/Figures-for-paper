...
This plot is later compared with the NRMS plot.
--> Theta begins increasing earlier than NRMS
--> shows that Theta provides greater lead time
"""
...
for file_num, re_val in sorted(re_data.items()):
    ...
    # normalized cumulative duration
